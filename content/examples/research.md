...
**Note:** The in-app **nav filter** (see [Get started](#docs/get-started)) loads the text index on **focus** and **hides non-matching items** in the same sidebar tree, using every page listed in `pages.yml` plus body text and frontmatter `title`.
